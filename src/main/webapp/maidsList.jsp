...
<body>
		...
		<%
			...
			ArrayList<Maid> list =(ArrayList) dao.getAllMaid();
		%>
		<%if(cid!=null){ %>
  ...
  <thead>
    <tr>
      ...
      <th><a type="button" href="maidregistration.jsp"><img style="margin-left: 45px;" alt="" src="IMAGE/addfemale.png" width="70px"></a></th>
    </tr>
  </thead>
  <tbody>
  <%if(list!=null){ 
